...
def render_console(con, panel, god, player, entities, game_map, fov_map, fov_recompute, msg_log, mouse):
    render_all(god, con, panel, entities, player, game_map, fov_map, fov_recompute, msg_log, mouse)

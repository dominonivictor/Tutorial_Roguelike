...
from interface.console import Console, Panel, Sidebar, render_console
...
def main():
    ...
    while not tcod.console_is_window_closed():
        ...
        render_console(con.console, pan.panel, sidebar.sidebar, the_game.god, the_game.player, the_game.entities, 
